...
public class BoardScript : MonoBehaviour {
  ...
  public GameObject charge_prefab;
    ...
    Transform charge_spawns = transform.Find("ChargeSpawns");
    foreach(Transform child in charge_spawns.transform){
      Network.Instantiate(charge_prefab, child.position, Quaternion.identity, 0);
    }
	}
